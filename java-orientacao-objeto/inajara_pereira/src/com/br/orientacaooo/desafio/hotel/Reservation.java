package com.br.orientacaooo.desafio.hotel;

import com.br.orientacaooo.desafio.hotel.exception.ReservationException;
...
public class Reservation {
    ...
    public void updateDates(Date checkIn, Date checkOut) {
        if (checkIn.before(new Date()) || checkOut.before(new Date())) {
            throw  new ReservationException("As datas para atualização da reserva deverão ser futuras!");
